...
Reduces computation while preserving small objects such as cars and poles.
...
Point cloud projected onto XY plane.
...
Buildings, Cars, Poles, Fences, Natural

Grid inflation applied for safety margins.

A* Path Planning

File: src/planning.py

Computes shortest collision-free path between selected start and goal.
...
Preprocessing visualizations (preprocessing_*.png)
